...
import 'package:schatbooks/view/post.dart';
...
class _HomeShowState extends State<HomeShow> {
 ...
 final dataProvideranother = FutureProvider.autoDispose((ref) => API.getAllPostusers());
  @override
  void initState() {
        ...
        children: [
              ...
              children: [
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    onTap: () {
                      Navigator.push(context, animation(page: const CreatePost()));
                    },
          ...
          Consumer(
            builder: (context, ref, child) {
              ...
              final data1 = ref.watch(dataProvideranother);
